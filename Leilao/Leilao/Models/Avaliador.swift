...
class Avaliador {
    ...
    func avalia(leilao:Leilao) throws {
        ...
        pegarOsMaioresLancesNoLeilao(leilao)
    }
    ...
    private func pegarOsMaioresLancesNoLeilao(_ leilao:Leilao) {
        guard let lances = leilao.lances else { return }
        maiores = lances.sorted(by: {(lista1, lista2) -> Bool in return lista1.valor > lista2.valor
        })
